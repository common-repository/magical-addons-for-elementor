...
class MgAddon_Dual_Button extends \Elementor\Widget_Base
{
    ...
    function register_content_controls()
    {
        ...
        $this->start_controls_section(
            'mg_db_button',
            [
                'label' => __('1st Button', 'magical-addons-for-elementor'),
                'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'mg_db_btn_use',
            [
                'label' => __('Use 1st Button?', 'magical-addons-for-elementor'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'magical-addons-for-elementor'),
                'label_off' => __('No', 'magical-addons-for-elementor'),
                'default' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-dual-btn .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dual-btn .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dual-btn .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-dual-btn:hover .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dual-btn:hover .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dual-btn:hover .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'mg_db_btn2_use',
            [
                'label' => __('Use 2nd Button?', 'magical-addons-for-elementor'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'magical-addons-for-elementor'),
                'label_off' => __('No', 'magical-addons-for-elementor'),
                'default' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 .left i' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-dual-btn2:hover .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1 i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1 svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1',
                'global' => [
                    'default' => Global_Typography::TYPOGRAPHY_PRIMARY,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1 i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1 svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:hover',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:hover, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:focus' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:hover i, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:focus i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:hover svg, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:focus svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:hover, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:focus' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:hover, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn1:focus' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2',
                'global' => [
                    'default' => Global_Typography::TYPOGRAPHY_PRIMARY,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2 svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:focus' => 'color: {{VALUE}};',

                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover i, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:focus i' => 'color: {{VALUE}};',

                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover svg, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:focus svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:focus' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:hover, {{WRAPPER}} .mg-dbtn-main a.mg-dual-btn2:focus' => 'border-color: {{VALUE}};',
                ],
            ]
        );
...
?>
    ...
    ?>
        ...
        <div class="mg-db-btn mg-dbtn-main style-two">
            <?php
            if ($mg_db_btn_use) {
                $this->mgf_button($settings, 1);
            }
    ...
    public function mgf_button($settings, $btn = 1)
    {
        if ($btn == 1) {
            ...
            $this->add_render_attribute('mg_db_btn_title', 'class', 'mg-dual-btn mg-dual-btn1');
            ...
            $this->add_render_attribute('mg_db_btn2_title', 'class', 'mg-dual-btn mg-dual-btn2');
    ...
    ?>
        ...
        <?php else : ?>
            <div class="mg-dual-btn-one">
                <a <?php echo $this->get_render_attribute_string($btn_attr); ?>><?php echo  mg_kses_tags($mg_db_btn_title); ?></a>
                <?php if ($btn == 1 && 'yes' === $settings['mg_db_show_btn_joint']) : ?>
                    <span class="mg-joint-btn"><?php echo mg_kses_tags($mg_db_btn_con_title); ?></span>
                <?php endif; ?>
            </div>
    ...
    {
    ?>
        <# var settings=settings; var mg_db_styles=settings['mg_db_styles']; function mgf_button(settings, btn) { var mg_flipbtn_icon_position, mg_db_usebtn_icon, mg_db_btn_title, mg_db_btn_con_title, mg_db_btn_link, mg_db_btn_selected_icon, btn_attr; var btn_attr='' ; if (btn===1) { mg_flipbtn_icon_position=settings['mg_flipbtn_icon_position']; mg_db_usebtn_icon=settings['mg_db_usebtn_icon']; mg_db_usebtn2_icon='' ; mg_db_btn_title=settings['mg_db_btn_title']; mg_db_btn_con_title=settings['mg_db_btn_con_title']; mg_db_btn_selected_icon=settings['mg_db_btn_selected_icon']; btn_attr='class="mg-dual-btn mg-dual-btn1"' ; var btn1Link=settings.mg_db_btn_link; if ( btn1Link ) { btn_attr +=' href="' + btn1Link.url + '"' ; if ( btn1Link.is_external ) { btn_attr +=' target="_blank"' ; } if ( btn1Link.nofollow ) { btn_attr +=' rel="nofollow"' ; } } } else { mg_flipbtn_icon_position=settings['mg_flipbtn2_icon_position']; mg_db_usebtn2_icon=settings['mg_db_usebtn2_icon']; mg_db_usebtn_icon='' ; mg_db_btn_title=settings['mg_db_btn2_title']; mg_db_btn_con_title=settings['mg_db_btn_con_title']; mg_db_btn_link=settings['mg_db_btn2_link']; mg_db_btn_selected_icon=settings['mg_db_btn2_selected_icon']; btn_attr='class="mg-dual-btn mg-dual-btn2"' ; var btn2Link=settings.mg_db_btn2_link; if ( btn2Link ) { btn_attr +=' href="' + btn2Link.url + '"' ; if ( btn2Link.is_external ) { btn_attr +=' target="_blank"' ; } if ( btn2Link.nofollow ) { btn_attr +=' rel="nofollow"' ; } } } #>
                ...
                <div class="mg-dual-btn-one">
                    <a {{{ btn_attr }}}>
                        <# if (mg_flipbtn_icon_position==='left' ) { #>
                            <span class="left">
                                <i class="{{{ mg_db_btn_selected_icon.value }}}"></i>
                            </span>
                            <# } #>
                                <span>{{{ mg_db_btn_title }}}</span>
                    ...
                    <# if (btn===1 && settings['mg_db_show_btn_joint']==='yes' ) { #>
                        <span class="mg-joint-btn">{{{ settings['mg_db_btn_con_title'] }}}</span>
                        <# } #>
                </div>
                <# } else { #>
                    <div class="mg-dual-btn-one">
                        <a {{{ btn_attr }}}>{{{ settings['mg_db_btn_title'] }}}</a>
                        <# if (btn===1 && settings['mg_db_show_btn_joint']==='yes' ) { #>
                            <span class="mg-joint-btn">{{{ settings['mg_db_btn_con_title'] }}}</span>
                            <# } #>
                    </div>
                    <# } #>
                        <# } if (mg_db_styles==='style1' ) { #>
                            <div class="mg-db-btn mg-dbtn-main style-one">
                                <# if ( settings.mg_db_btn_use ) { mgf_button(settings, 1); } #>
                                    <# if ( settings.mg_db_btn2_use ) { mgf_button(settings, 2); } #>
                            </div>
                            <# } else { #>
                                <div class="mg-db-btn mg-dbtn-main style-two">
                                    <# if ( settings.mg_db_btn_use ) { mgf_button(settings, 1); } #>
