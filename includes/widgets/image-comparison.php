...
/*
	 protected function content_template() {
		...
		?>
			<div class="mg-image-comparison item-visiable" id="mg-image-comparison-{{ settings._id }}" data-settings="{{ JSON.stringify(settings.widget_options) }}">
				<#
				if ( settings.before_image.url ) {

					

			var mgBeforeImageCom = {
			...
			var beforeImageSrc = elementor.imagesManager.getImageUrl( mgBeforeImageCom );

				#>
					<img src="{{ beforeImageSrc }}" alt="{{ settings.before_image.alt }}" title="{{ settings.before_image.title }}" class="mg-before-img" />
				<#
				}
				...
				if ( settings.after_image.url ) {
					...
					var afterImageSrc = elementor.imagesManager.getImageUrl( mgAfterImageCom );
				#>
					<img src="{{ afterImageSrc }}" alt="{{ settings.after_image.alt }}" title="{{ settings.after_image.title }}" class="mg-after-img" />
				<#
				}
				#>
			</div>
