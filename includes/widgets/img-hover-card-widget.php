...
class MgimgHover_Card_Widget extends \Elementor\Widget_Base
{
    ...
    function register_content_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn i.left,
                    {{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn .left i' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn svg.left,
                    {{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn i.right,
                     {{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn svg.right,
                     {{WRAPPER}} .mg-hvr-card .mg-hvrcard-btn .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-hvrcard-btn i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-hvrcard-btn svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-hvrcard-btn i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-hvrcard-btn svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-hvrcard-btn:hover i, {{WRAPPER}} .mg-hvrcard-btn:focus i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-hvrcard-btn:hover svg, {{WRAPPER}} .mg-hvrcard-btn:focus svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_inline_editing_attributes('mg_hvrcard_btn_title');
...
?>
    ...
    ?>
        ...
        <# var settings=settings; var mgCardImage={ id: settings.mg_hvrcard_img.id, url: settings.mg_hvrcard_img.url, size: settings.mghvr_thumbnail_size, dimension: settings.mghvr_thumbnail_custom_dimension, model: view.getEditModel() }; var mgcard_image_url=elementor.imagesManager.getImageUrl( mgCardImage ); var mg_hvrcard_desc=settings.mg_hvrcard_desc; view.addInlineEditingAttributes('mg_hvrcard_desc', 'none' ); var mg_hvrcard_title=settings.mg_hvrcard_title; view.addInlineEditingAttributes('mg_hvrcard_title', 'none' ); view.addRenderAttribute('mg_hvrcard_title', 'class' , 'mg-hvrcard-title' ); var mg_hvrcard_btn_title=settings.mg_hvrcard_btn_title; view.addInlineEditingAttributes('mg_hvrcard_btn_title', 'none' ); var title_tag=settings.mg_hvrcard_title_tag; view.addRenderAttribute('mg_hvrcard_btn_title', 'class' , 'mg-btn' ); view.addRenderAttribute('mg_hvrcard_btn_title', 'class' , 'mg-hvrcard-btn' ); var iconHTML=elementor.helpers.renderIcon( view, settings.mg_hvrcard_btn_selected_icon, { 'aria-hidden' : true }, 'i' , 'object' ), migrated=elementor.helpers.isIconMigrated( settings, 'mg_hvrcard_btn_selected_icon' ); #>

            <div class="mg-hvr-card">
                <figure class="{{{ settings.mg_hvr_card_effects }}} mg-hcard-main">
                    <img src="{{{ mgcard_image_url }}}" alt="{{ settings.mg_hvrcard_img.alt }}">
                    <figcaption>
                        <div class="mg-hvrcap-text">


                            <# if ( mg_hvrcard_title ) { #>
                                <{{{ title_tag }}} {{{ view.getRenderAttributeString('mg_hvrcard_title') }}}>{{{ mg_hvrcard_title }}}</{{{ title_tag }}}>
                                <# } #>

                                    <# if ( mg_hvrcard_desc ) { #>
                                        <p {{{ view.getRenderAttributeString('mg_hvrcard_desc') }}}>{{{ mg_hvrcard_desc }}}</p>
                                        <# } #>

                                            <# if ( settings.mg_hvrcard_btn_use ) { var useBtnIcon=settings.mg_hvrcard_usebtn_icon==='yes' ; var btnIconPosition=settings.mg_hvrcardbtn_icon_position; #>
                                                <# if ( useBtnIcon ) { #>
                                                    <a href="{{ settings.mg_hvrcard_btn_link.url }}" target="{{ settings.mg_hvrcard_btn_link.is_external ? '_blank' : '_self' }}" {{{ settings.mg_hvrcard_btn_link.nofollow ? 'rel="nofollow"' : '' }}} {{{ view.getRenderAttributeString('mg_hvrcard_btn_title') }}}>
                                                        <# if ( btnIconPosition==='left' ) { #>
                                                            <span class="left">
                                                                {{{ iconHTML.value }}}
                                                            </span>
                                                            <# } #>
                                                                <span>{{{ mg_hvrcard_btn_title }}}</span>
                                                                <# if ( btnIconPosition==='right' ) { #>
                                                                    <span class="right">
                                                                        {{{ iconHTML.value }}}
                                                                    </span>
                                                                    <# } #>
                                                    ...
                                                    <# } else { #>
                                                        <a href="{{ settings.mg_hvrcard_btn_link.url }}" target="{{ settings.mg_hvrcard_btn_link.is_external ? '_blank' : '_self' }}" {{{ settings.mg_hvrcard_btn_link.nofollow ? 'rel="nofollow"' : '' }}} {{{ view.getRenderAttributeString('mg_hvrcard_btn_title') }}}>{{{ mg_hvrcard_btn_title }}}</a>
                                                        <# } #>
                                                            <# } #>
                        </div>
                    </figcaption>
