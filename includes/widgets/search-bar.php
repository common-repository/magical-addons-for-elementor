		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .mg-search-form-submit i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .mg-search-form-submit svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .mg-search-form-submit:hover i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .mg-search-form-submit:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
